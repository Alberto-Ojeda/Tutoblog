...
INSERT INTO `productos` VALUES (1,'produc1',10),(2,'Producto2',1.12),(3,'Producto3',23.3),(4,'PLAYERA',192),(7,'PANTA',1231);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `productos_mayus` BEFORE INSERT ON `productos` FOR EACH ROW begin
