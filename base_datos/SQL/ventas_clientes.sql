...
INSERT INTO `clientes` VALUES (1,'Cliente1','Apel21'),(2,'Cliente2','Apellido2'),(3,'Cliente3','Apellido3'),(4,'CLIENTE1','APELLIDO1'),(12,'dasda','AS'),(13,'Pablo','jimenz'),(14,'FRANCISCO','SANCHEZ');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `clientes_mayus` BEFORE INSERT ON `clientes` FOR EACH ROW begin
